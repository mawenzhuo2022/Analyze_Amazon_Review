...
# 主函数
def main(data):
    base_path = os.path.abspath("app/backend/dat/analyze/test")
    ...
    try:
        ...
        save_data_to_csv(X_train, 'app/backend/dat/analyze/cleaned_data/X_train.csv')
        save_data_to_csv(X_test, 'app/backend/dat/analyze/cleaned_data/X_test.csv')
        save_data_to_csv(y_train, 'app/backend/dat/analyze/cleaned_data/Y_train.csv')
        save_data_to_csv(y_test, 'app/backend/dat/analyze/cleaned_data/Y_test.csv')
